  ...
  return (
    <div className="pList">
        ...
        <div className="pListItem">
            ...
            <div className="pListTitle">
                <h1>Apartments</h1>
                <span>122 Apartments</span>
            </div>
        </div>
        <div className="pListItem">
            <img
            src="https://q-xx.bstatic.com/xdata/images/hotel/263x210/100235855.jpeg?k=5b6e6cff16cfd290e953768d63ee15f633b56348238a705c45759aa3a81ba82b&o=://r-xx.bstatic.com/xdata/images/xphoto/263x210/57584488.jpeg?k=d8d4706fc72ee789d870eb6b05c0e546fd4ad85d72a3af3e30fb80ca72f0ba57&o="
            alt="Villas"
            className='pListImg'
            />
            <div className="pListTitle">
                <h1>Villas</h1>
                <span>122 Villas</span>
            </div>
        </div>
        <div className="pListItem">
            <img
